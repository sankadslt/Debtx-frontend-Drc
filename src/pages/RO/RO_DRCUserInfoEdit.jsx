      ...
      <div className="flex gap-4 mt-4 justify-center">
        <div className={`${GlobalStyle.cardContainer} relative`}>
          <div className="absolute top-4 right-4">
            ...
            >
              <div
                className={`w-5 h-5 rounded-full bg-white absolute top-[2px] transition-all ${
                  status ? "left-[26px]" : "left-[2px]"
                }`}
              />
            </div>
          </div>
          ...
          <div className="table">
            <div className="table-row">
              ...
              <div className="table-cell px-4 py-2">
                {itemData?.added_date || "mm/dd/yyyy"}
              </div>
            </div>
            <div className="table-row">
              <div className="table-cell px-4 py-2 font-semibold">
              ...
              <div className="table-cell px-4 py-2 font-semibold">:</div>
              <div className="table-cell px-4 py-2">
                {itemData?.drcUser_name ||
                  itemData?.recovery_officer_name ||
                  "Mr. Sunil Perera"}
              </div>
            </div>
            <div className="table-row">
                  ...
                  <tbody>
                    {rtomAreas.map((area, index) => (
                      <tr key={index}>
                        ...
                        <td className={`${GlobalStyle.tableData} text-center`}>
                          <div
                            className={`inline-block w-11 h-6 rounded-full transition-colors ${
                              area.status ? "bg-green-500" : "bg-gray-400"
                            } relative`}
                            onClick={() => {
                              const newRtomAreas = [...rtomAreas];
                              newRtomAreas[index].status =
                                !newRtomAreas[index].status;
                          ...
                          >
                            <div
                              className={`w-5 h-5 rounded-full bg-white absolute top-[2px] transition-all ${
                                area.status ? "left-[26px]" : "left-[2px]"
                              }`}
                            />
                          </div>
                        </td>
