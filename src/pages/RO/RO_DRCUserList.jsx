...
export default function RO_DRCUserList() {
  ...
  const handleFilter = async () => {
    try {
      ...
      const response = await List_All_RO_and_DRCuser_Details_to_DRC(payload).catch(
        (error) => {
    ...
    <div className={GlobalStyle.fontPoppins}>
        ...
        <div>
          ...
          <div className="flex justify-end mt-6">
            <button
              ...
              onClick={() => navigate("/ro/ro-drc-user-info")}
            >
              Add RO
            </button>
          </div>
      ...
      {activeTab === "drcUser" && (
        <div>
          ...
          <div className="flex justify-end mt-6">
            <button className={GlobalStyle.buttonPrimary}>Add DRC User</button>
          </div>
        </div>
      )}
