            ...
            <div className={GlobalStyle.fontPoppins}>
                ...
                >
                    <table className={`${GlobalStyle.table} w-full text-left`}>
                        <tbody>
                            {/* Customer Identification Title */}
                            <tr className="block sm:table-row">
                                <td className={`${GlobalStyle.tableData} font-medium whitespace-nowrap underline sm:table-cell w-1/3 sm:w-1/4`}>
                                    Customer Identifications
                                </td>
                            </tr>
                            ...
                            <tr className="block sm:table-row">
                                <td className={`${GlobalStyle.tableData} font-medium whitespace-nowrap sm:table-cell w-1/3 sm:w-1/4 underline`}>
                                    Contact Details
                                </td>
                            </tr>
