...
const Routers = () => {
  return (
    <Routes>
      ...
      <Route path="/pages/Distribute/DistributeTORO" element={<ProtectedRoute element={<DistributeTORO />} allowedRoles={['superadmin', 'drc_user', 'DRC-Coordinator']} />} />

      {/* DRC Routes */}
      <Route path="/dummy" element={<ProtectedRoute element={<Dummy />} allowedRoles={['superadmin']} />} />

      {/* DRC Routes for 2.1 to 2.5 - Distribute to RO*/}
      <Route path="/drc/assigned-case-list-for-drc" element={<ProtectedRoute element={<AssignedCaseListforDRC />} allowedRoles={['superadmin', 'drc_user', 'DRC-Coordinator']} />} />
      ...
      <Route path="/drc/ro-monitoring-arrears" element={<ProtectedRoute element={<RO_Monitoring />} allowedRoles={['superadmin', 'drc_user', 'DRC-Coordinator']} />} />
      <Route path="/drc/assigned-ro-case-log" element={<ProtectedRoute element={<AssignedROcaselog />} allowedRoles={['superadmin', 'drc_user', 'DRC-Coordinator']} />} />
      ...
      <Route path="/pages/DRC/Re-AssignRo" element={<ProtectedRoute element={<Re_AssignRo />} allowedRoles={['superadmin', 'drc_user', 'DRC-Coordinator']} />} />


      {/* DRC/RO Routes for 2.15 to 2.16 - Mediation Board*/}
      <Route path="/drc/mediation-board-case-list" element={<ProtectedRoute element={<MediationBoardcaselist />} allowedRoles={['superadmin', 'drc_user', 'RO', 'DRC-Coordinator']} />} />
      ...
      <Route path="/pages/DRC/Mediation Board Response" element={ <ProtectedRoute element={<Mediation_board_response />} allowedRoles={['superadmin', 'drc_user', 'RO', 'DRC-Coordinator']} />} />


      {/* DRC/RO Routes for 2.6 to 2.7.1 - Negotiation*/}
      <Route path="/drc/ro-s-assigned-case-log" element={<ProtectedRoute element={<ROsAssignedcaseLog />} allowedRoles={['superadmin', 'drc_user', 'RO', 'DRC-Coordinator']} />} />
